...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        var tableajax = $('#myTable').DataTable({
          responsive: true,
            ajax: '<?php echo base_url("C_apoteker/getAjax") ?>',
            columns: [
             { 
                data: null,
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_apoteker/add')?>",
                dataType : "JSON",
                data : {id:id, id_user:id_user, nip:nip, nama:nama, alamat:alamat, no_tlp:no_tlp, jk:jk},
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_apoteker/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(id, id_user, nip, nama, alamat, no_tlp, jk){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_apoteker/update')?>",
                dataType : "JSON",
                data : {id:id, id_user:id_user, nip:nip, nama:nama, alamat:alamat, no_tlp:no_tlp, jk:jk},
                success: function(data){
                    $('[name="id_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_apoteker/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
